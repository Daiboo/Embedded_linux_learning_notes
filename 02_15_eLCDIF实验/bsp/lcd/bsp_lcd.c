...
void lcd_init(void)
{
    ...
    tftlcd_dev.hbpd = 46;
    tftlcd_dev.hfpd = 210;
    lcdclk_init(50, 3, 3);	/* 初始化LCD时钟 33.3MHz */


	tftlcd_dev.pixsize = 4;				/* RGB8888模式，每个像素3字节 */
 ...
 *                	  LCD CLK = 24 * loopDiv/ 4 / prediv / div
